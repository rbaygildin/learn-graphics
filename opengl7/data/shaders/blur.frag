...
//
//	return vec3(res);
    res += texture2D(colorTexture, texcoord + vec2(-1.0, -1.0) * pstep) * 0.0625;
    res += texture2D(colorTexture, texcoord + vec2(0.0, -1.0) * pstep) * 0.1250;
    res += texture2D(colorTexture, texcoord + vec2(1.0, -1.0) * pstep) * 0.0625;
    res += texture2D(colorTexture, texcoord + vec2(-1.0, 0.0) * pstep) * 0.1250;
    res += texture2D(colorTexture, texcoord + vec2(0.0, 0.0) * pstep) * 0.2500;
    res += texture2D(colorTexture, texcoord + vec2(1.0, 0.0) * pstep) * 0.1250;
    res += texture2D(colorTexture, texcoord + vec2(-1.0, 1.0) * pstep) * 0.0625;
    res += texture2D(colorTexture, texcoord + vec2(0.0, 1.0) * pstep) * 0.1250;
    res += texture2D(colorTexture, texcoord + vec2(1.0, 1.0) * pstep) * 0.0625;
